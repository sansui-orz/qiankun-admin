...
import { theme, Card, Tabs } from "antd";
  ...
  return (
    ...
    >
      <Card
        ...
        style={{ width: 600 }}
        cover={
          <div className="w-full bg-center bg-no-repeat bg-cover h-200" style={{ backgroundImage: `url(${banners[4]})`, borderRadius: '8px 8px 0 0'}}>
            {/* <div className="w-full h-200 abc"></div> */}
          </div>
        }
      >
